...
// Cross Module References
	FIT2097_AAA2_API UClass* Z_Construct_UClass_ACampFire_NoRegister();
	FIT2097_AAA2_API UClass* Z_Construct_UClass_ACampFire();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_FIT2097_AAA2();
	FIT2097_AAA2_API UFunction* Z_Construct_UFunction_ACampFire_ApplyFireDamage();
	FIT2097_AAA2_API UFunction* Z_Construct_UFunction_ACampFire_OnOverlapBegin();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FHitResult();
	ENGINE_API UClass* Z_Construct_UClass_UPrimitiveComponent_NoRegister();
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	FIT2097_AAA2_API UFunction* Z_Construct_UFunction_ACampFire_OnOverlapEnd();
...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ACampFire()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_ACampFire_ApplyFireDamage, "ApplyFireDamage" }, // 1854018314
				{ &Z_Construct_UFunction_ACampFire_OnOverlapBegin, "OnOverlapBegin" }, // 1544182277
				{ &Z_Construct_UFunction_ACampFire_OnOverlapEnd, "OnOverlapEnd" }, // 585330121
			};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ACampFire, 2831781674);
	static FCompiledInDefer Z_CompiledInDefer_UClass_ACampFire(Z_Construct_UClass_ACampFire, &ACampFire::StaticClass, TEXT("/Script/FIT2097_AAA2"), TEXT("ACampFire"), false, nullptr, nullptr, nullptr);
